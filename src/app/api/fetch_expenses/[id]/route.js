...
export async function GET(request, { params }) {
  ...
  console.log(emp_id, startDate, endDate);
  ...
  // Construct the SQL query based on whether startDate and endDate are provided
  let sqlQuery = "SELECT * FROM expense_details WHERE emp_id = ?";
  let queryParams = [emp_id];
